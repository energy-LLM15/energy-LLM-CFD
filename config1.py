...
class llm_config:
    ...
    DEEPSEEK_R1_MODEL_NAME : str = field(default="deepseek-reasoner", metadata={"description": "R1 model name"})  # NEW
    ...
    DEEPSEEK_V3_MODEL_NAME : str = field(default="deepseek-chat", metadata={"description": "V3/chat model name"})  # NEW
